# File: fine-tuned-model-demo/api.py
...
async def lifespan(app: FastAPI):
    ...
    # This path is relative to *this api.py file*
    # It goes up one level (..) then into the colab folder
    ADAPTER_DIR = "./distilgpt2_finetuned_adapter"
